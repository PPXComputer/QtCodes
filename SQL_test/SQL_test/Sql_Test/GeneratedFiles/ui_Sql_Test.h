...
public:
    ...
    void setupUi(QWidget *Sql_TestClass)
    {
        if (Sql_TestClass->objectName().isEmpty())
            Sql_TestClass->setObjectName(QStringLiteral("Sql_TestClass"));
        ...
        sql_Edit->setObjectName(QStringLiteral("sql_Edit"));
        ...
        sql_words->setObjectName(QStringLiteral("sql_words"));
